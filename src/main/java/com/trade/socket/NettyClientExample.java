...
//        );
        ...
        SubscriptionConfig jsonConfig = new SubscriptionConfig(
                subscriptionTopic -> "{\"action\":\"subscribe\",\"topic\":\"" + subscriptionTopic + "\"}",
                subscriptionTopic -> "{\"action\":\"unsubscribe\",\"topic\":\"" + subscriptionTopic + "\"}"
        );
...
//        );
        ...
        client.startClient("client1", "ws://localhost:8080/websocket1", jsonConfig, callback,false,new String[]{},new String[]{});
//        client.startClient("client2", "wss://example.com:443/websocket2", simpleConfig, callback);

        // 订阅主题
        client.subscribe("client1", "topic1");
